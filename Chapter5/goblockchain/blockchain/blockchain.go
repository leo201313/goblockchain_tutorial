...
// 	if !bytes.Equal(tx.ID,tx.TxHash()) {  //validate hash
// 		return false
// 	}

// 	fromaddress := tx.Inputs[0].FromAddress
// 	validOutputs :=
// }

// func (bc *BlockChain)ValidateTransactions(txs []*transaction.Transaction)(bool,int){
